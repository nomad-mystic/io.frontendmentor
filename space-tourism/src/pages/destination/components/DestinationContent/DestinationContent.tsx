    ...
    return (
        <section data-testid="DestinationContentComponent">
            <article>
                ...
                <p className="DestinationContent-body Body max-w-[444px] block" data-testid="DestinationContentComponent-body">{ props.data.body }</p>

                <section className="DestinationContent-data flex flex-col md:flex-row">
                    <div className="DestinationContent-distance">
                        <h4>AVG. DISTANCE</h4>
                        <p className="Subheading-1" data-testid="DestinationContentComponent-distance">{ props.data.distance }</p>
                    </div>
                    <div className="DestinationContent-travel">
                        <h4>Est. travel time</h4>
                        <p className="Subheading-1" data-testid="DestinationContentComponent-time">{ props.data.time }</p>
                    </div>
                </section>
            </article>
        </section>
