        ...
        <>
            ...
            <main className="HomePage-main max-w-container">
                <section className="HomePage-left">
                    ...
                    <p className="HomePage-body Subheading-2">Let’s face it; if you want to go to space, you might as well genuinely go to outer space and not hover kind of on the edge of it. Well sit back, and relax because we’ll give you a truly out of this world experience!</p>
                </section>
